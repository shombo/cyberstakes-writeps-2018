...
if __name__ == '__main__':
	# pulled from the server socket, base64 decoded
	encrypted = '9;1AHINJIMNHOLLKKJ@AI'
	### same as encrypt just removing the base64 encode
	decrypted = bytes(ooooooo(encrypted), 'utf-8').decode('utf-8')
